---
name: ui-library
description: Estándar estricto para el Sistema de Diseño y Librería de Componentes Reutilizables de React Frontend (DRY, Variables CSS, Estructura por carpetas). Use when working on files matching: src/**/*.tsx, src/components/**/*.
metadata:
  hermes:
