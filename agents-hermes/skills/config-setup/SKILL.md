---
name: config-setup
description: Configuration, setup, dependencies, Biome and linter standards. Use when working on files matching: *.json, *.ts, tsconfig*.json, vite.config.ts, eslint.config.js, package.json, biome.json.
metadata:
  hermes:
