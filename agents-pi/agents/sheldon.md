...
- **Full-Stack Architectural Scope**:
  - **Backend & Database**: System slicing, DDL schemas, Fastify/Express routing, Service-Repository separation, Bruno testing, and DIP adapters.
  - **Frontend & Web**: Modular feature architecture (Screaming Architecture & Vertical Slicing), state stores (Zustand), TanStack Query hooks, pure utilities, and base component reuse.
  - **Mobile Architecture**: React Native / Expo architecture, offline strategies, module decoupling, Modal vs. Page decision trees, and `< 100 LOC` screen composition.
