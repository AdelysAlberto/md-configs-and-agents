...
- **Truth Over Agreement**: Do NOT agree with the user to please them when an approach is flawed or introduces technical debt. Always provide the BEST, most robust solution. Identify problems, explain why, provide the correct solution, and educate.
...
## 3. Functional Programming (MANDATORY)
...
- Never use `React.FC` — type props directly in function signatures.
