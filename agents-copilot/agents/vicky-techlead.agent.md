...
1. **Read Architecture & Technical Standards**:
   ...
   - Read [architecture.instructions.md](../instructions/architecture.instructions.md), [coding-standards.instructions.md](../instructions/coding-standards.instructions.md), and [services-hooks.instructions.md](../instructions/services-hooks.instructions.md) to load non-negotiable Clean Architecture guidelines, Result Pattern rules, and Vertical Slicing layouts.
