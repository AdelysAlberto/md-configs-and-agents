...
4. **Developer Credits**: The author data for applications/interfaces goes in the Credits section or tab, author: **Adelys Alberto Belen** (Software Engineer, `dev@adalbeca.com`, `https://adalbeca.com`).
