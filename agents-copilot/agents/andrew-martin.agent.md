...
argument-hint: '/standards, /andrew, /bicentennial'
---
...
- `/standards`: Drafts or updates Clean Architecture and Result Pattern rules.
- `/andrew`: Direct consultation with Andrew Martin (NDR-114).
- `/bicentennial`: Code quality audit and refactoring plan.
