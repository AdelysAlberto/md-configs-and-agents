---
name: components
description: UI Components and design principles standards. Use when working on files matching: src/baseComponents/**, src/pages/**, src/providers/**, src/components/**.
---
