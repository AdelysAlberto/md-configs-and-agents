...
description: Universal coding standards, zero-tolerance anti-patterns, pure functional TypeScript/languages, Biome, and engineering rigor. Use when working on files matching: src/**/*.ts, src/**/*.tsx, src/**/*.js, src/**/*.jsx, src/**/*.go, src/**/*.py, **.
---
...
## 6. Strict DRY Invariant & Pure Reusable Utilities
